...
class NumberTestCase(django.test.TestCase):
    ...
    def test_floats_and_strings(self):
        ...
        f__s(         0.0039520263671875, '0q81FF_0103')
        ...
        zone_boundary()
        f__s(         0.0,                '0q80',  '0q807F')
        zone_boundary()
        f__s(         0.0,                '0q80')
        zone_boundary()
        f__s(         -0.0,               '0q80',  '0q7F81')
        zone_boundary()
        ...
        f__s(        -0.001953125,        '0q7E01_80')
        f__s(        -0.0038604736328125, '0q7E01_03')
        f__s(        -0.003875732421875,  '0q7E01_02')
        f__s(        -0.0038909912109375, '0q7E01_01')   # -255/65536
        f__s(        -0.00390625,         '0q7E00_FF', '0q7E01')   # alias for -1/256
        f__s(        -0.00390625,         '0q7E00_FF')   # -256/65536
        f__s(        -0.0039215087890625, '0q7E00_FEFF') # -257/65536
        f__s(        -0.003936767578125,  '0q7E00_FEFE')
        f__s(        -0.0039520263671875, '0q7E00_FEFD')
